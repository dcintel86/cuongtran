...
public class TestCreate  implements IAnnotationTransformer{
	...
	public void transform (ITestAnnotation testannotation, Class testClass, Constructor testConstructor, Method testMethod) {
		...
		if (!dataFile.equals("NA") & !dataSheet.equals("NA")) {
			final Object [][] arrayObject = ReadExcel.getExcelData(System.getProperty("user.dir")+ File.separator + "data" + File.separator + "Excel" + File.separator + dataFile,dataSheet);
